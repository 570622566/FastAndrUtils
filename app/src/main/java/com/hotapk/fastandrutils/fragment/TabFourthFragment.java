 ...
 */
public class TabFourthFragment extends FLazyFragment {
    private TextView tv_text;

    public TabFourthFragment() {
    }

    // TODO: Rename and change types and number of parameters
    public static TabFourthFragment newInstance() {
        TabFourthFragment fragment = new TabFourthFragment();
        return fragment;
    }
    ...
    public void initLoad() {
        tv_text.setText("加载第四个数据");
    }

    @Override
    public void initView(View view) {
        tv_text = view.findViewById(R.id.tv_text);
        FLogUtils.getInstance().e("第四个frame加载数据");
        tv_text.setText("加载第四个数据");
