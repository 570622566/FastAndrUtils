 ...
 * @author laijian
 * @version 2017/9/20
 * @Copyright (C)下午3:59 , www.hotapk.cn
 * 设备相关类
 */
@SuppressLint({"HardwareIds", "MissingPermission"})
public final class FDeviceUtils {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) FUtils.getAppContext()
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = FUtils.getAppContext().getContentResolver();
     ...
     */
    public static void getAllSMS(String filepath) {
        // 1.获取短信
        // 1.1获取内容解析者
        ContentResolver resolver = FUtils.getAppContext().getContentResolver();
