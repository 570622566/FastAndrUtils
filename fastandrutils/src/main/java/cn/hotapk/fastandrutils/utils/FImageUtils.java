...
public final class FImageUtils {
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return bitmap == null ? null : new BitmapDrawable(FUtils.getAppContext().getResources(), bitmap);
    }
    ...
    public static Bitmap getBitmap(final File file) {
        ...
        InputStream is = null;
        InputStream fileinp = FFileUtils.file2Inp(file.getAbsolutePath());
        if (fileinp != null) {
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId) {
        Drawable drawable = ContextCompat.getDrawable(FUtils.getAppContext(), resId);
    ...
    public static Bitmap renderScriptBlur(final Bitmap src,
        ...
        Bitmap ret = recycle ? src : src.copy(src.getConfig(), true);
        try {
            rs = RenderScript.create(FUtils.getAppContext());
    ...
    public static String getImageType(final File file) {
        if (file == null) return null;
        InputStream is = FFileUtils.file2Inp(file.getAbsolutePath());
        try {
            if (is != null) {
